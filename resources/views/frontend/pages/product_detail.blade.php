...
@endsection
@section('title','Laracommerce | PRODUCT DETAIL')
									...
									<div class="col-lg-6 col-12">
										<div class="product-des">
											...
											<div class="short">
                                                ...
                                                @endphp
												<p class="price"><span class="discount">Rp.{{number_format($after_discount,)}}</span><s>Rp.{{number_format($product_detail->price,)}}</s> </p>
                                ...
                                <div class="single-product">
                                    ...
                                    <div class="product-content">
                                        ...
                                        <div class="product-price">
                                            ...
                                            @endphp
                                            <span class="old">Rp.{{number_format($data->price,)}}</span>
