							...
							<div class="col-lg-4 col-md-7 col-12">
								<div class="right">
									<ul>
										...
										<li class="coupon_price" data-price="{{Session::get('coupon')['value']}}">You Save<span>Rp.{{number_format(Session::get('coupon')['value'],)}}</span></li>
										@endif
										@php
										...
										@endphp
										@if(session()->has('coupon'))
											<li class="last" id="order_total_price">You Pay<span>Rp.{{number_format($total_amount,)}}</span></li>
										@else
											<li class="last" id="order_total_price">You Pay<span>Rp.{{number_format($total_amount,)}}</span></li>
										@endif
									</ul>
									<div class="button5">
										<a href="{{route('rajaongkir')}}" class="btn" style="">Shipping Services</a>
										<a href="{{route('midtrans')}}" class="btn">Checkout</a>
